...
class Dataset(utils.Dataset):
    ...
    def load_data(self, annotation_json, images_dir,train_val_dir):
        ...
        source_name = "annot_like"
        df_class_name = ['none','low', 'medium', 'high']
        for i, class_name in  enumerate(df_class_name):  
            class_id = i+ 1
            if class_id < 1:
    ...
    def load_mask(self, image_id):
        ...
        for annotation in annotations:
            ...
            damage_factor = attribute["damage factor"]
            ...
            for segmentation in annotation['segmentation'] :
                ...
                class_ids.append(int(damage_factor) + 1)
